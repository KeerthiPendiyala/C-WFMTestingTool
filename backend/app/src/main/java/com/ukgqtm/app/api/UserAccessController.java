...
public class UserAccessController {
    ...
    public UserListResponse list(Authentication authentication, HttpServletRequest request) {
        requireAdministrator(authentication, request);
        return new UserListResponse(users.listUsers(AuthenticatedPrincipal.require(authentication)));
    }
    ...
    private void requireAdministrator(Authentication authentication, HttpServletRequest request) {
